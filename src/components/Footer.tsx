    ...
    <footer className="shell pb-12 pt-16">
      ...
      <div className="flex flex-col gap-10 pt-12 sm:flex-row sm:items-start sm:justify-between">
        ...
        <nav className="flex flex-col gap-3">
          <span className="text-[11px] font-medium uppercase tracking-label text-haze">
            Navigate
          </span>
          {links.map((l) => (
            <a
      ...
      <div className="mt-14 flex flex-col gap-3 border-t border-line pt-6 text-sm text-haze sm:flex-row sm:items-center sm:justify-between">
